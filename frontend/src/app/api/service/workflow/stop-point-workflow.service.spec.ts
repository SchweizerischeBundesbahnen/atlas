...
describe('StopPointWorkflowService', () => {
  ...
  it('should getStopPointWorkflow', () => {
    ...
    // then
    expect(apiService.get).toHaveBeenCalledExactlyOnceWith('/workflow/v1/stop-point/workflows/1');
  });
  ...
  it('should startStopPointWorkflow', () => {
    ...
    // then
    expect(apiService.post).toHaveBeenCalledExactlyOnceWith('/workflow/internal/stop-point/workflows/start/1');
  });
  ...
  it('should getExaminants', () => {
    ...
    // then
    expect(apiService.get).toHaveBeenCalledExactlyOnceWith('/workflow/internal/stop-point/workflows/541654/examinants');
  });
  ...
  it('should restartStopPointWorkflow', () => {
    const stopPointRestartWorkflow: StopPointRestartWorkflow = {
      designationOfficial: 'NewWashington',
      mail: '',
      organisation: '',
    };
