...
export class StopPointWorkflowService {
  ...
  getStopPointWorkflows(
    ...
    sloids?: Array<string>,
    designationOfficial?: Array<string>,
    localityName?: string,
    sboids?: Array<string>,
    createdAt?: string,
    versionValidFrom?: Date,
    filterByNoDecision?: boolean,
    page?: number,
    size?: number,
    sort?: Array<string>
  ): Observable<ContainerReadStopPointWorkflow> {
  ...
  editStopPointWorkflow(id: number, editStopPointWorkflow: EditStopPointWorkflow): Observable<ReadStopPointWorkflow> {
    ...
    return this.atlasApiService.post(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/edit/${encodeURIComponent(String(id))}`,
  ...
  addExaminantsToStopPointWorkflow(id: number, addExaminants: AddExaminants) {
    ...
    return this.atlasApiService.post(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/add-examinants/${encodeURIComponent(String(id))}`,
      addExaminants
    );
  }
  ...
  getDecision(personId: number): Observable<ReadDecision> {
    return this.atlasApiService.get(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/decisions/${encodeURIComponent(String(personId))}`
    );
  }
  ...
  overrideVoteWorkflow(id: number, personId: number, overrideDecision: OverrideDecision): Observable<void> {
    ...
    return this.atlasApiService.post(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/override-vote/${encodeURIComponent(String(id))}/${encodeURIComponent(String(personId))}`,
      overrideDecision
    );
  }
  ...
  verifyOtp(id: number, otpVerification: OtpVerification): Observable<StopPointPerson> {
    ...
    return this.atlasApiService.post(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/verify-otp/${encodeURIComponent(String(id))}`,
      otpVerification
    );
  }
  ...
  voteWorkflow(id: number, personId: number, decision: Decision): Observable<void> {
    ...
    return this.atlasApiService.post(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/vote/${encodeURIComponent(String(id))}/${encodeURIComponent(String(personId))}`,
      decision
    );
  }
  ...
  getExaminants(servicePointVersionId: number): Observable<Array<StopPointPerson>> {
    return this.atlasApiService.get(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/${encodeURIComponent(String(servicePointVersionId))}/examinants`
    );
  }

  cancelStopPointWorkflow(
    id: number,
    stopPointRejectWorkflow: StopPointRejectWorkflow
  ): Observable<ReadStopPointWorkflow> {
    this.atlasApiService.validateParams({ id, stopPointRejectWorkflow });
    return this.atlasApiService.post(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/cancel/${encodeURIComponent(String(id))}`,
      stopPointRejectWorkflow
    );
  }

  rejectStopPointWorkflow(
    id: number,
    stopPointRejectWorkflow: StopPointRejectWorkflow
  ): Observable<ReadStopPointWorkflow> {
    this.atlasApiService.validateParams({ id, stopPointRejectWorkflow });
    return this.atlasApiService.post(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/reject/${encodeURIComponent(String(id))}`,
      stopPointRejectWorkflow
    );
  }

  restartStopPointWorkflow(
    id: number,
    stopPointRestartWorkflow: StopPointRestartWorkflow
  ): Observable<ReadStopPointWorkflow> {
    this.atlasApiService.validateParams({ id, stopPointRestartWorkflow });
    return this.atlasApiService.post(
      `${this.STOP_POINT_WORKFLOW_INTERNAL}/restart/${encodeURIComponent(String(id))}`,
