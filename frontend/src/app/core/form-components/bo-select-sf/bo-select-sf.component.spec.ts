...
import { BoSelectSfComponent } from './bo-select-sf.component';
...
class MockSearchSelectSfComponent {
...
describe('BoSelectSfComponent', () => {
  let fixture: ComponentFixture<BoSelectSfComponent>;
  let component: BoSelectSfComponent;
  ...
  const getSearchSelect = () =>
    fixture.debugElement.query(By.directive(MockSearchSelectSfComponent))?.componentInstance as
      MockSearchSelectSfComponent | undefined;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [BoSelectSfComponent],
      providers: [{ provide: BusinessOrganisationService, useValue: businessOrganisationService }],
    }).overrideComponent(BoSelectSfComponent, {
      remove: {
        imports: [AtlasLabelFieldComponent, BoSelectionDisplayPipe, SearchSelectSfComponent],
      },
      add: {
        imports: [MockAtlasLabelFieldComponent, MockBoSelectionDisplayPipe, MockSearchSelectSfComponent],
      },
    });

    fixture = TestBed.createComponent(BoSelectSfComponent);
