...
const VALID_COMBINATIONS: [ApplicationType, BusinessObjectType, ImportType][] = [
  ...
  [ApplicationType.Sepodi, BusinessObjectType.ServicePointGlobalId, ImportType.Update],
  ...
  [ApplicationType.Sepodi, BusinessObjectType.Sector, ImportType.Update],
  ...
  [ApplicationType.Prm, BusinessObjectType.StopPoint, ImportType.Terminate],
  [ApplicationType.Lidi, BusinessObjectType.Line, ImportType.Create],
