    ...
    return new FormGroup<DecisionFormGroup>(
      {
        ...
        [this._motivation]: new FormControl(existingDecision?.motivation, [AtlasFieldLengthValidator.comments]),
      },
      {
        validators: DecisionFormGroupBuilder.conditionallyRequired(this._judgement, this._motivation),
      }
    );
  }
