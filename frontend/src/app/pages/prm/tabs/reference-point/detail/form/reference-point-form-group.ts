...
import { ReadReferencePointVersion, ReferencePointAttributeType, ReferencePointVersion } from '../../../../../../api';
    ...
    return new FormGroup<CompleteReferencePointFormGroup>(
      {
        ...
        designation: new FormControl(version?.designation, [Validators.required, Validators.maxLength(50)]),
