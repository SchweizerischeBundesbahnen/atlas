...
import { AtlasTextFieldComponent } from './atlas-text-field.component';
...
describe('AtlasTextFieldComponent', () => {
  let fixture: ComponentFixture<AtlasTextFieldComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [AtlasTextFieldComponent],
      providers: [translateServiceProvider],
    }).overrideComponent(AtlasTextFieldComponent, {
      remove: { imports: [AtlasLabelFieldComponent, AtlasFieldErrorComponent] },
      add: { imports: [MockAtlasLabelFieldComponent, MockAtlasFieldErrorComponent] },
    });

    fixture = TestBed.createComponent(AtlasTextFieldComponent);
  ...
  it('should always render atlas-field-error', () => {
    expect(getFieldError()).toBeTruthy();
  });

  it('should pass the field input to atlas-field-error', () => {
