...
import ch.sbb.exportservice.job.sepodi.servicepoint.entity.ServicePointGeolocation.ServicePointGeolocationBuilder;
...
public class ServicePointVersionRowMapper extends BaseSepodiRowMapper implements RowMapper<ServicePointVersion> {
