...
public class TimetableFieldNumberExportBatchConfig {
  ...
  public JdbcCursorItemReader<TimetableFieldNumber> timetableFieldNumberReader(
    ...
    JdbcCursorItemReader<TimetableFieldNumber> itemReader = new JdbcCursorItemReader<>(dataSource, TimetableFieldNumberSqlQueryUtil.getSqlQuery(exportTypeV2),
        new TimetableFieldNumberRowMapper());
  ...
  public Step exportTtfnCsvStep(ItemReader<TimetableFieldNumber> itemReader) {
    ...
    return new StepBuilder(stepName, jobRepository)
        .<TimetableFieldNumber, TimetableFieldNumberCsvModel>chunk(StepUtil.CHUNK_SIZE)
  ...
  public Step exportTtfnJsonStep(ItemReader<TimetableFieldNumber> itemReader) {
    ...
    return new StepBuilder(stepName, jobRepository)
        .<TimetableFieldNumber, TimetableFieldNumberVersionModel>chunk(StepUtil.CHUNK_SIZE)
        .transactionManager(transactionManager)
        .reader(itemReader)
