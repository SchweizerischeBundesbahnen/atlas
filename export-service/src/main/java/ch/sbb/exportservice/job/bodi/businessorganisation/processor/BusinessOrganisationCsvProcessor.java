...
public class BusinessOrganisationCsvProcessor implements ItemProcessor<BusinessOrganisation, BusinessOrganisationCsvModel> {
  ...
  public BusinessOrganisationCsvModel process(BusinessOrganisation businessOrganisation) {
    ...
    return BusinessOrganisationCsvModel.builder()
        ...
        .validFrom(DATE_FORMATTER_BASE.format(businessOrganisation.getValidFrom()))
        .validTo(DATE_FORMATTER_BASE.format(businessOrganisation.getValidTo()))
        ...
        .creationTime(LOCAL_DATE_TIME_FORMATTER.format(businessOrganisation.getCreationDate()))
        .editionTime(LOCAL_DATE_TIME_FORMATTER.format(businessOrganisation.getEditionDate()))
        .build();
  }
