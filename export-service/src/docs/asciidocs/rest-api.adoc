...
include::../../../../base-atlas/documentation/data-consuming-rules/when_to_use_files_or_API.adoc[]

include::../../../../atlas-s3/documentation/Amazon_S3_Buckets_Users_Onboarding.adoc[]
