...
class BaseExportTypeTest {
  ...
  void shouldContainWorld() {
    assertThat(BaseExportType.WORLD)
        .extracting(JobParams::getExportTypeV2)
        .containsExactly(ExportTypeV2.WORLD_FULL, ExportTypeV2.WORLD_ACTUAL, ExportTypeV2.WORLD_TIMETABLE_YEARS);
  }
  ...
  void shouldContainSwiss() {
    assertThat(BaseExportType.SWISS)
        .extracting(JobParams::getExportTypeV2)
        .containsExactly(ExportTypeV2.SWISS_FULL, ExportTypeV2.SWISS_ACTUAL, ExportTypeV2.SWISS_TIMETABLE_YEARS);
  }
  ...
  void shouldContainSwissWorld() {
    assertThat(BaseExportType.SWISS_WORLD)
        .extracting(JobParams::getExportTypeV2)
        .containsExactly(ExportTypeV2.WORLD_FULL, ExportTypeV2.WORLD_ACTUAL,
