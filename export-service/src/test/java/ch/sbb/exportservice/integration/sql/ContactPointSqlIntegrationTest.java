...
class ContactPointSqlIntegrationTest extends BasePrmSqlIntegrationTest {
  ...
  void shouldReturnTimetableYears() throws SQLException {
    ...
    insertContactPoint(2, "ch:1:sloid:7001:1", ServicePointNumber.ofNumberWithoutCheckDigit(8507000),
        actualTimetableYearChangeDate, actualTimetableYearChangeDate);
    insertContactPoint(20, "ch:1:sloid:7001:1", ServicePointNumber.ofNumberWithoutCheckDigit(8507000),
        actualTimetableYearChangeDate.minusMonths(5),
        actualTimetableYearChangeDate.minusMonths(4));
    insertContactPoint(200, "ch:1:sloid:7001:1", ServicePointNumber.ofNumberWithoutCheckDigit(8507000),
