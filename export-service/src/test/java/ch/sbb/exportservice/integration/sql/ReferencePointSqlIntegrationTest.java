...
class ReferencePointSqlIntegrationTest extends BasePrmSqlIntegrationTest {
  ...
  void shouldReturnTimetableYears() throws SQLException {
    ...
    insertReferencePoint(2, "ch:1:sloid:7001:1", ServicePointNumber.ofNumberWithoutCheckDigit(8507000),
        actualTimetableYearChangeDate, actualTimetableYearChangeDate);
    insertReferencePoint(20, "ch:1:sloid:7001:1", ServicePointNumber.ofNumberWithoutCheckDigit(8507000),
        actualTimetableYearChangeDate.minusMonths(5),
        actualTimetableYearChangeDate.minusMonths(4));
    insertReferencePoint(200, "ch:1:sloid:7001:1", ServicePointNumber.ofNumberWithoutCheckDigit(8507000),
