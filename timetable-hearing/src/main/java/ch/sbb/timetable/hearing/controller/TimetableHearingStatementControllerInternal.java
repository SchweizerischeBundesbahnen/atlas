...
import ch.sbb.timetable.hearing.exception.ForbiddenDueWrongStatementTimeTableYearException;
...
import ch.sbb.timetable.hearing.service.ResponsibleTransportCompaniesResolverService;
import ch.sbb.timetable.hearing.service.TimetableFieldNumberResolverService;
import ch.sbb.timetable.hearing.service.TimetableHearingStatementAlternationService;
import ch.sbb.timetable.hearing.service.TimetableHearingStatementExportService;
...
public class TimetableHearingStatementControllerInternal implements TimetableHearingStatementApiInternal {
  ...
  public List<TimetableHearingAnonymStatementCsvModel> getStatementsByIdAnonymized(List<Long> ids) {
    return timetableHearingStatementService.getStatementsByIdAnonymized(ids);
  }
