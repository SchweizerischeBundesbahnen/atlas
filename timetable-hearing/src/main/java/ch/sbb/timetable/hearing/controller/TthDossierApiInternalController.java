...
import ch.sbb.timetable.hearing.api.TthDossierApiInternal;
import ch.sbb.timetable.hearing.entity.TthDossier;
import ch.sbb.timetable.hearing.mapper.TthDossierMapper;
import ch.sbb.timetable.hearing.model.TthDossierTuCsvModel;
import ch.sbb.timetable.hearing.search.TthDossierRequestParams;
import ch.sbb.timetable.hearing.search.TthDossierSearchRestrictions;
import ch.sbb.timetable.hearing.service.TthDossierCsvExportService;
import ch.sbb.timetable.hearing.service.TthDossierService;
import java.io.File;
