...
public class BulkImportTemplateGenerator {
  ...
  static {
    ...
    templateLookup.put(
        BulkImportConfig.builder()
            .application(ApplicationType.SEPODI)
            .objectType(BusinessObjectType.SERVICE_POINT_GLOBAL_ID)
            .importType(ImportType.UPDATE)
            .build(),
        () -> ServicePointTemplateGenerator.SERVICE_POINT_GLOBAL_ID_UPDATE_CSV_MODEL
    );
    ...
    templateLookup.put(
        BulkImportConfig.builder()
            ...
            .importType(ImportType.UPDATE)
            .build(),
        () -> SectorTemplateGenerator.SECTOR_UPDATE_CSV_MODEL
    );
    ...
    templateLookup.put(
        BulkImportConfig.builder()
            ...
            .importType(ImportType.CREATE)
            .build(),
        () -> SectorGroupTemplateGenerator.SECTOR_GROUP_CREATE_CSV_MODEL
    );
