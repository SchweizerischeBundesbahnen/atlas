...
public class StopPointTerminateReader extends StopPointTerminate implements BulkImportItemReader {

  @Override
  public List<BulkImportUpdateContainer<?>> apply(File file) {
    List<BulkImportUpdateContainer<SloidTerminateCsvModel>> stopPointTerminateCsvModels =
        ReaderUtil.readAndValidate(file,
            SloidTerminateCsvModel.class);

    log.info("Read {} lines to import", stopPointTerminateCsvModels.size());
    return new ArrayList<>(stopPointTerminateCsvModels);
  }
