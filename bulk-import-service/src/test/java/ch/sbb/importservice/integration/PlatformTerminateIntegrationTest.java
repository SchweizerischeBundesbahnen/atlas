...
@Slf4j
@IntegrationTest
class PlatformTerminateIntegrationTest {
  ...
  void shouldImportPlatformsAndTerminateViaApi() throws IOException {
    ...
    // When
    MockMultipartFile multipartFile = new MockMultipartFile("file", "platform-terminate", CSV_CONTENT_TYPE,
