...
public class OpenApiMerger {
  ...
  private OpenAPI createAtlasApi(Map<String, OpenAPI> apis) {
    StringBuilder description = new StringBuilder().append(
            "This is the API for all your needs with SKI core data.")
        .append(NEWLINE)
        .append(NEWLINE)
    ...
    description
        .append("</ul>")
        .append(NEWLINE)
        .append("Atlas gets updated with the following features: "
            + "<a href='https://atlas-info.app.sbb.ch/static/atlas-release-notes.html' target='_blank'>Atlas Release Notes</a>");
