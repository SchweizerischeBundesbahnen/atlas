...
import ch.sbb.atlas.versionable.BaseTest.VersionableObject.Fields;
...
class VersionableServiceScenario9Test extends VersionableServiceBaseTest {
 ...
 /**
   * ATLAS-1752
   * Szenario 9b: keine current version matching
   * Änderung mit start Version 1
   *                                     |_______________|
   *|---------------| |----------------|
   *   Version 1         Version 2
   ...
   */
  @Test
   void scenario9bToTheFutureChangesFromNoMatchingVersion() {
   //given
   versionableObject1 = VersionableObject
       .builder()
       .id(1L)
  ...
  */
 @Test
 void scenario9bToThePastChangesNoMatchingVersion() {
  //given
  versionableObject1 = VersionableObject
      .builder()
      .id(1L)
