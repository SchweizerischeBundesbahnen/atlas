...
class VersionableServiceScenario13Test extends VersionableServiceBaseTest {
   ...
   * Version:      1       2           3
   *
   * RESULTAT: |--------|_____________|---|
   * Version:      1        2           3
   */
  @Test
   void scenario13cOnlyValidToEdited() {
    //given
    LocalDate editedValidTo = versionableObject2.getValidTo().plusMonths(2);
