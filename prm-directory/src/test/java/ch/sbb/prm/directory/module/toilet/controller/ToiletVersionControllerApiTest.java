package ch.sbb.prm.directory.module.toilet.controller;
...
class ToiletVersionControllerApiTest extends BaseControllerApiTest {
  ...
  void shouldNotCreateToiletWithViolation() throws Exception {
    ...
    model.setDesignation(RandomStringUtils.secureStrong().next(51));
    model.setAdditionalInformation(RandomStringUtils.secureStrong().next(20001));
