package ch.sbb.prm.directory.module.stoppoint;
...
import ch.sbb.prm.directory.module.stoppoint.entity.StopPointVersion.StopPointVersionBuilder;
...
public class StopPointTestData {
  ...
  public static StopPointVersionModel getCompleteNotValidatableStopPointReducedCreateVersionModel() {
    return StopPointVersionModel.builder()
        ...
        .freeText(RandomStringUtils.insecure().next(AtlasFieldLengths.LENGTH_2000 + 1, true, false))
        .address(RandomStringUtils.insecure().next(AtlasFieldLengths.LENGTH_2000 + 1, true, false))
        .zipCode(RandomStringUtils.insecure().next(AtlasFieldLengths.LENGTH_50 + 1, true, false))
        .city(RandomStringUtils.insecure().next(AtlasFieldLengths.LENGTH_75 + 1, true, false))
        .alternativeTransport(StandardAttributeType.TO_BE_COMPLETED)
        .shuttleService(StandardAttributeType.TO_BE_COMPLETED)
        .alternativeTransportCondition(RandomStringUtils.insecure().next(AtlasFieldLengths.LENGTH_2000 + 1, true, false))
        .assistanceAvailability(StandardAttributeType.YES)
        .assistanceCondition(RandomStringUtils.insecure().next(AtlasFieldLengths.LENGTH_2000 + 1, true, false))
        .assistanceService(StandardAttributeType.NO)
        .audioTicketMachine(StandardAttributeType.PARTIALLY)
        .dynamicAudioSystem(StandardAttributeType.TO_BE_COMPLETED)
        .dynamicOpticSystem(StandardAttributeType.TO_BE_COMPLETED)
        .infoTicketMachine(RandomStringUtils.insecure().next(AtlasFieldLengths.LENGTH_2000 + 1, true, false))
        .additionalInformation(RandomStringUtils.insecure().next(AtlasFieldLengths.LENGTH_2000 + 1, true, false))
        .interoperable(true)
        .url(RandomStringUtils.insecure().next(AtlasFieldLengths.LENGTH_500 + 1, true, false))
        .visualInfo(StandardAttributeType.TO_BE_COMPLETED)
        .wheelchairTicketMachine(StandardAttributeType.TO_BE_COMPLETED)
        .assistanceRequestFulfilled(BooleanOptionalAttributeType.TO_BE_COMPLETED)
        .ticketMachine(BooleanOptionalAttributeType.TO_BE_COMPLETED)
  ...
  public StopPointVersionBuilder<?, ?> builderVersion2() {
    return StopPointVersion.builder()
        ...
        .shuttleService(StandardAttributeType.YES)
        .alternativeTransportCondition("No way dude!!")
        .assistanceAvailability(StandardAttributeType.YES)
        .assistanceCondition("No alternative Bro!")
        .assistanceService(StandardAttributeType.NO)
