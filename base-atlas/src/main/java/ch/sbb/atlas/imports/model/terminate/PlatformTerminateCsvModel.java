...
public class PlatformTerminateCsvModel implements Validatable<PlatformTerminateCsvModel> {
  ...
  @Override
  public List<UniqueField<PlatformTerminateCsvModel>> uniqueFields() {
    return List.of(new UniqueField<>(PlatformTerminateCsvModel.Fields.sloid, PlatformTerminateCsvModel::getSloid));
  }
