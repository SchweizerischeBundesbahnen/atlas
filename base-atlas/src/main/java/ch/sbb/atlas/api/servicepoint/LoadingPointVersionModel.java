...
public abstract class LoadingPointVersionModel extends BaseVersionModel implements DatesValidator, Versionable {
  ...
  @Schema(description = """
      This ID helps identify versions of a loading point in the use case front end and/or update.
      This ID can be deleted if the version is no longer present. Do not use this ID to map your object to a loading point.
