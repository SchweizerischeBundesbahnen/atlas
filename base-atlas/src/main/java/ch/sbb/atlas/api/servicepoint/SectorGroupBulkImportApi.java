...
@Tag(name = AtlasApiConstants.INTERNAL_API_TAG_PREFIX + "Sector Group Bulk Import")
public interface SectorGroupBulkImportApi {

  String BASEPATH = "internal/sector-groups/bulk-import";
  ...
  List<BulkImportItemExecutionResult> bulkImportCreate(
      @RequestBody List<BulkImportUpdateContainer<SectorGroupCreateCsvModel>> bulkImportCreateContainers);
