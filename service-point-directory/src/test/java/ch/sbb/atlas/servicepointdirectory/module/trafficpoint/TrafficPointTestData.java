package ch.sbb.atlas.servicepointdirectory.module.trafficpoint;

import static ch.sbb.atlas.servicepointdirectory.module.servicepoint.ServicePointTestData.WYLEREGG_NUMBER;
