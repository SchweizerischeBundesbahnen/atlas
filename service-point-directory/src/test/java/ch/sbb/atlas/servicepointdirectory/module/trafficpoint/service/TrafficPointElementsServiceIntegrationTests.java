...
class TrafficPointElementsServiceIntegrationTests extends BaseTrafficPointElementsServiceIntegrationTest {
  ...
  @Autowired
  TrafficPointElementsServiceIntegrationTests(TrafficPointElementVersionRepository trafficPointElementVersionRepository,
  ...
  void scenario3UpdateVersion2ByAddingTrafficPointElementGeolocation() {
    ...
    assertThat(thirdTemporalVersion.getTrafficPointElementGeolocation().getEast()).isEqualTo(
        TrafficPointTestData.getTrafficPointGeolocationBernMittelland().getEast());
    assertThat(thirdTemporalVersion.getTrafficPointElementGeolocation().getNorth()).isEqualTo(
        TrafficPointTestData.getTrafficPointGeolocationBernMittelland().getNorth());
    assertThat(thirdTemporalVersion.getTrafficPointElementGeolocation().getHeight()).isEqualTo(
        TrafficPointTestData.getTrafficPointGeolocationBernMittelland().getHeight());
    ...
    assertThat(fourthTemporalVersion.getTrafficPointElementGeolocation().getSpatialReference()).isEqualTo(
        TrafficPointTestData.getTrafficPointGeolocationBernMittelland().getSpatialReference());
    assertThat(fourthTemporalVersion.getTrafficPointElementGeolocation().getEast()).isEqualTo(
        TrafficPointTestData.getTrafficPointGeolocationBernMittelland().getEast());
    assertThat(fourthTemporalVersion.getTrafficPointElementGeolocation().getNorth()).isEqualTo(
        TrafficPointTestData.getTrafficPointGeolocationBernMittelland().getNorth());
    assertThat(fourthTemporalVersion.getTrafficPointElementGeolocation().getHeight()).isEqualTo(
        TrafficPointTestData.getTrafficPointGeolocationBernMittelland().getHeight());
  ...
  @Test
  void scenario13cOnlyValidToEdited() {
    // given
    version1.setValidFrom(LocalDate.of(2000, 1, 1));
    version1.setValidTo(LocalDate.of(2000, 12, 31));
    version1 = trafficPointElementVersionRepository.save(version1);
    ...
    editedVersion.setValidTo(LocalDate.of(2002, 1, 31));
    editedVersion.setVersion(version2.getVersion());
    // when
    trafficPointElementService.updateTrafficPointElementVersion(version2, editedVersion);
    List<TrafficPointElementVersion> result = trafficPointElementVersionRepository.findAllBySloidOrderByValidFrom(SLOID);
    ...
    TrafficPointElementVersion secondTemporalVersion = result.get(1);
    assertThat(secondTemporalVersion.getValidFrom()).isEqualTo(LocalDate.of(2001, 1, 1));
    assertThat(secondTemporalVersion.getValidTo()).isEqualTo(LocalDate.of(2002, 1, 31));
    assertThat(secondTemporalVersion.getSloid()).isEqualTo(SLOID);

    // updated
    TrafficPointElementVersion thirdTemporalVersion = result.get(2);
    assertThat(thirdTemporalVersion.getValidFrom()).isEqualTo(LocalDate.of(2002, 2, 1));
    assertThat(thirdTemporalVersion.getValidTo()).isEqualTo(LocalDate.of(2002, 12, 31));
    assertThat(thirdTemporalVersion.getSloid()).isEqualTo(SLOID);
  }
