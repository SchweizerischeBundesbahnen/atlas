...
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.entity.ServicePointVersion.ServicePointVersionBuilder;
...
@IntegrationTest
class ServicePointValidationServiceIT {
  ...
  @Autowired
  ServicePointValidationServiceIT(ServicePointValidationService servicePointValidationService,
