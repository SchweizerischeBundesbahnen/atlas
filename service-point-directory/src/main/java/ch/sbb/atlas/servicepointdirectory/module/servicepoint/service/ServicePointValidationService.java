...
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.abbreviationsallowlist.ServicePointAbbreviationAllowList;
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.entity.ServicePointVersion;
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.exception.AbbreviationUpdateNotAllowedException;
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.exception.ForbiddenDueToChosenServicePointVersionValidationPeriodException;
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.exception.InvalidAbbreviationException;
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.exception.InvalidFareStopException;
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.exception.InvalidFreightServicePointException;
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.exception.ServicePointDesignationLongConflictException;
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.exception.ServicePointDesignationOfficialConflictException;
